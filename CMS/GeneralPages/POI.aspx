...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        //<![CDATA[
            ...
            function initialize() {
                var mapOptions = {
                    center: new google.maps.LatLng(-35.308235, 149.124224), zoom: 13, mapTypeId: google.maps.MapTypeId.ROADMAP };        
    ...
    <div class="wrapper1">
        ...
        <div class="wrapper2">
            <!-- ========== POI List (Grid View) in the middle ========== -->
            <div class="contentList poi">
                <asp:GridView ID="POIGridView" runat="server" AllowSorting="True"   AutoGenerateColumns="False" CellPadding="4" DataKeyNames="ItemID"
                    DataSourceID="POIObjectDataSource" ForeColor="#333333" GridLines="None"  Width="100%" onrowdatabound="POIGridView_RowDataBound" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ItemName" HeaderText="POI Name"  SortExpression="ItemName">
                            <ItemStyle/>
                        </asp:BoundField>
                ...
                <asp:ObjectDataSource ID="POIObjectDataSource" runat="server" SelectMethod="getAllPOIList"   TypeName="CMS.BLL.CMSBLClass" 
                    OldValuesParameterFormatString="original_{0}">
                </asp:ObjectDataSource>
            </div>        
            <!--========== POI Detail (Multi View) on the right========== -->
                    ...
                    <asp:MultiView ID="POIMultiView" runat="server">                        
                            ...
                            <h1> Point Of Interest Details
                                <span class = "detailButtons">
                                    ...
                                    <asp:ConfirmButtonExtender ID="DeleteButton_ConfirmButtonExtender" OnClientCancel="CancelClick"
                                        runat="server" ConfirmText="Are you sure you want to delete the selected POI?"  Enabled="True" TargetControlID="DeleteButton">
                        ...
                        <asp:View ID="InsertView" runat="server">
                            ...
                            <asp:DropDownList ID="SubtypeDropDownList" runat="server"  DataSourceID="SubtypeObjectDataSource" DataTextField="SubType" 
                                DataValueField="SubTypeID" Width="405px"  ondatabound="SubtypeDropDownList_DataBound">
                            </asp:DropDownList>
                            ...
                            <asp:DropDownList ID="MajorRegionDropDownList" runat="server"  DataSourceID="MajorRegionObjectDataSource" DataTextField="MajorRegionName" 
                                DataValueField="MajorRegionID" Width="405px"  ondatabound="MajorRegionDropDownList_DataBound">
                            </asp:DropDownList>
