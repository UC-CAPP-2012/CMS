...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="wrapper1">
        ...
        <div class="wrapper2">
            <!-- ========== Category List (Grid View) in the middle ========== -->
            <div class="contentList category">
                <asp:GridView ID="GridViewCategory" runat="server" AllowSorting="True"  AutoGenerateColumns="False" CellPadding="4" DataKeyNames="CategoryID" 
                    DataSourceID="ObjectDataSourceCategory" ForeColor="#333333" GridLines="None" onrowdatabound="GridViewCategory_RowDataBound" 
                    ...
                    <EmptyDataTemplate> There is no category. </EmptyDataTemplate>
                ...
                <asp:ObjectDataSource ID="ObjectDataSourceCategory" runat="server"  DeleteMethod="DeleteCategory" InsertMethod="InsertCategory" 
                    SelectMethod="getAllCategory" TypeName="CMS.BLL.CMSBLClass"  UpdateMethod="UpdateCategory"  OldValuesParameterFormatString="original_{0}">
                    <DeleteParameters>
            ...
            <!-- ========== Category Detail (Multi View) on the right ========== -->
                ...
                <div class="contentDetailWrapper">
                    ...
                    <asp:MultiView ID="CategoryMultiView" runat="server">
                        ...
                        <asp:View ID="DetailView" runat="server">
                            ...
                            <hr />
                            <asp:Label ID="NameLabel" runat="server" CssClass="label" Font-Bold="True" Text="Category Name : " Width="150px"></asp:Label>
                        ...
                        <asp:View ID="InsertView" runat="server">
                            ...
                            <div class="detailButtons bottom">
                                ...
                                ConfirmText="Do you want to submit the new category?" Enabled="True"  TargetControlID="SubmitNewButton" ConfirmOnFormSubmit="True">
                                </asp:ConfirmButtonExtender>
