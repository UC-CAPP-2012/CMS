<%@ Page Title="CAPP CMS - Major Region" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MajorRegion.aspx.cs" Inherits="CMS.GeneralPages.MajorRegion" %>
    ...
    <div class="wrapper1">
       <!-- ========== Sub menu on the left ==========  -->
        <div class="contentLeftMenu">
            <h1> Major Region </h1>
            <ul>
                <li><span style="margin-left: -1em;"></span><asp:LinkButton ID="InsertLinkButton" runat="server" onclick="InsertLinkButton_Click"> 
                    Insert New Region </asp:LinkButton></li>
            </ul>
        </div>
        <div class="wrapper2">
            <!-- ========== Major Region List (Grid View) in the middle ========== -->
            ...
            <asp:GridView ID="GridViewRegion" runat="server" AllowSorting="True" 
                ...
                <EmptyDataTemplate>
                    <span/>There is no major region.</span>
                </EmptyDataTemplate>
            ...
            <!-- ========== Major Region Detail (Multi View) on the right ========== -->
                ...
                <div class="contentDetailWrapper">
                    ...
                    <asp:MultiView ID="RegionMultiView" runat="server">
                        ...
                        <asp:View ID="DetailView" runat="server">
                            ...
                            <hr />
                            <asp:Label ID="NameLabel" runat="server" CssClass="label" Font-Bold="True" Text="Region Name : " Width="150px"></asp:Label>
                        ...
                        <asp:View ID="InsertView" runat="server">
                            ...
                            <div class="detailButtons bottom">
                                ...
                                <asp:ConfirmButtonExtender ID="ConfirmButtonExtender2" OnClientCancel="CancelClick" runat="server" 
                                    ConfirmText="Do you want to submit the new region?" Enabled="True"  TargetControlID="SubmitNewButton" ConfirmOnFormSubmit="True">
                                </asp:ConfirmButtonExtender>
                                <asp:Button ID="InsertCancelButton" runat="server" Text="Cancel" Width="70px"  CausesValidation="False" 
