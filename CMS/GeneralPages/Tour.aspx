<%@ Page Title="CAPP CMS - Tour" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Tour.aspx.cs" Inherits="CMS.GeneralPages.Tour" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="wrapper1">
        ...
        <div class="contentLeftMenu">
            <h1> Tour </h1>
            <ul>
                <li><span style="margin-left: -1em;" ></span><asp:LinkButton ID="InsertLinkButton" runat="server" CausesValidation="False"
                        onclick="InsertLinkButton_Click"> Insert New Tour </asp:LinkButton></li>
            </ul>
        </div>
        <div class="wrapper2">
            <!-- ========== Tour List (Grid View) in the middle ========== -->
            <div class="contentList tour">
                <asp:GridView ID="TourGridView" runat="server" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="TourID"
                    DataSourceID="TourObjectDataSource" ForeColor="#333333" GridLines="None"  Width="100%" onrowdatabound="TourGridView_RowDataBound" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="TourID" HeaderText="TourID" InsertVisible="False" ReadOnly="True" SortExpression="TourID" Visible="False" />
                        <asp:BoundField DataField="TourName" HeaderText="TourName"  SortExpression="TourName" />
                    </Columns>
                    <EditRowStyle BackColor="#999999" />
                    <EmptyDataTemplate>
                        <span/>There is no tour.</span>
                    </EmptyDataTemplate>
                ...
                <asp:ObjectDataSource ID="TourObjectDataSource" runat="server" SelectMethod="getAllTours"  TypeName="CMS.BLL.CMSBLClass" 
                    OldValuesParameterFormatString="original_{0}">
                </asp:ObjectDataSource>
            </div>
            <!--========== Tour Detail (Multi View) on the right========== -->
                ...
                <div class="contentDetailWrapper tour">
                    ...
                    <asp:MultiView ID="TourMultiView" runat="server">
                        ...
                        <asp:View ID="DetailView" runat="server">
                            <h1> Tour Details
                                <span class = "detailButtons">
                                    ...
                                    <asp:ConfirmButtonExtender ID="DeleteButton_ConfirmButtonExtender" OnClientCancel="CancelClick"
                                        runat="server" ConfirmText="Are you sure you want to delete the selected Tour?" Enabled="True" TargetControlID="DeleteButton">
                            ...
                            <p>
                                <asp:Label ID="DetailLocationLabel" runat="server" CssClass="label"  Font-Bold="True" Text="Tour Locations : " Width="150px"></asp:Label>
                                <asp:ListBox ID="ViewLocationListBox" runat="server"  DataSourceID="ObjectDataSource1" DataTextField="ItemName" 
                                    DataValueField="ItemID" Height="200px" Width="300px"></asp:ListBox>
                                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="getTourPOIListByTourID" TypeName="CMS.BLL.CMSBLClass">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="TourGridView" Name="tourID"  PropertyName="SelectedValue" Type="Int32" />
                                    </SelectParameters>
                                </asp:ObjectDataSource>
                            </p>
                            <p>
                            ...
                            <div class="clear"></div>
                            <p>
                                <asp:Label ID="DetailVideoLabel" runat="server" CssClass="label" Enabled="False" Font-Bold="True" Text="Video : " Width="150px"></asp:Label>
                            </p>
                            ...
                            <div ID="poiImages" runat="server" width="460px"></div><br/><asp:HiddenField ID="TourIDHiddenField" runat="server" />
                        </asp:View>
                            ...
                            <div class="TourLocationMaster">
                                ...
                                <div class="POIList">
                                    ...
                                    <asp:LinkButton ID="SearchLinkButton" runat="server" CausesValidation="false" 
                                        CssClass="button small lightGray search" Width="20px" Height="11px"  onclick="SearchLinkButton_Click"></asp:LinkButton>
                                    ...
                                    <asp:LinkButton ID="ViewAllLinkButton" runat="server" CausesValidation="false"  CssClass="button small lightGray" Width="100px" 
                                        onclick="ViewAllLinkButton_Click">View All</asp:LinkButton>
                                    <asp:LinkButton ID="SelectLinkButton" runat="server" CausesValidation="false"  CssClass="button small lightGray right" Width="100px" 
                                        onclick="SelectLinkButton_Click">Select</asp:LinkButton>
                                </div>
                                <!--========== Selected POIs for this Tour ==========-->
                                <div class="SelectedPOIList">                                    
                                    ...
                                    <asp:LinkButton ID="UpLinkButton" runat="server" CausesValidation="false" 
                                        CssClass="button small lightGray up" Height="9px" Width="30px"  onclick="UpLinkButton_Click"></asp:LinkButton>
                                    <asp:LinkButton ID="DownLinkButton" runat="server" CausesValidation="false" 
                                        CssClass="button small lightGray down" Height="9px" Width="30px"  onclick="DownLinkButton_Click"></asp:LinkButton>
                                    <asp:LinkButton ID="RemoveLinkButton" runat="server" CausesValidation="false" 
                                        CssClass="button small lightGray right" Width="118px"  onclick="RemoveLinkButton_Click">Remove</asp:LinkButton>
