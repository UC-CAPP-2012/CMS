<%@ Page Title="CAPP CMS - Event" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Event.aspx.cs" Inherits="CMS.GeneralPages.Event" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        //<![CDATA[
            ...
            //Map bind
            function initialize() {
                var mapOptions = { center: new google.maps.LatLng(-35.308235, 149.124224), zoom: 13, mapTypeId: google.maps.MapTypeId.ROADMAP };
                ...
                //Display map for the location selected using auto complete.
                google.maps.event.addListener(autocomplete, 'place_changed', function () {
                    ...
                    // Set the values of lat and long hiddenfields with the selected location's geocode. 
                    ...
                    // Display info window to show the selected location's address details.
                    var address = '';
    ...
    <div class="wrapper1">
        ...
        <div class="wrapper2">
            <!-- ========== Event List (Grid View) in the middle ========== -->
            <div class="contentList event">
                <asp:GridView ID="EventGridView" runat="server" AllowSorting="True"  AutoGenerateColumns="False" CellPadding="4" Width="100%" 
                DataKeyNames="ItemID"  DataSourceID="EventObjectDataSource" ForeColor="#333333" GridLines="None" 
                onrowdatabound="EventGridView_RowDataBound"  onselectedindexchanged="EventGridView_SelectedIndexChanged">
                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                    <Columns>
                        <asp:CommandField SelectText="" ShowSelectButton="True">
                            <ItemStyle Width="5px" />
                        </asp:CommandField>
                        <asp:BoundField DataField="ItemName" HeaderText="Event Name" SortExpression="ItemName" />
                        ...
                        <asp:BoundField DataField="ItemID" HeaderText="ItemID" SortExpression="ItemID" InsertVisible="False" Visible="False" />
                    </Columns>
                ...
                <asp:ObjectDataSource ID="EventObjectDataSource" runat="server"  SelectMethod="getAllEventList" TypeName="CMS.BLL.CMSBLClass" 
                    OldValuesParameterFormatString="original_{0}">
                </asp:ObjectDataSource>
            </div>
            <!--========== Event Detail (Multi View) on the right========== -->
                ...
                <div class="contentDetailWrapper">
                    ...
                    <asp:MultiView ID="EventMultiView" runat="server">
                        ...
                        <asp:View ID="DetailView" runat="server">
                            ...
                            <span class = "detailButtons">
                                ...
                                <asp:ConfirmButtonExtender ID="DeleteButton_ConfirmButtonExtender" OnClientCancel="CancelClick"
                                    runat="server" ConfirmText="Are you sure you want to delete the selected event?"  Enabled="True" TargetControlID="DeleteButton">
                            ...
                            <p>
                                <asp:Label ID="DetailSuburbLabel" runat="server" CssClass="label"  Font-Bold="True" Text="Suburb : " Width="150px"></asp:Label>
                        ...
                        <asp:View ID="InsertView" runat="server">
                            ...
                            <asp:DropDownList ID="SubtypeDropDownList" runat="server"  DataSourceID="SubtypeObjectDataSource" DataTextField="SubType" 
                                DataValueField="SubTypeID" Width="405px"/></asp:DropDownList>
                            <asp:ObjectDataSource ID="SubtypeObjectDataSource" runat="server"  SelectMethod="getAllSubtype" TypeName="CMS.BLL.CMSBLClass" 
                            ...
                            <asp:DropDownList ID="MajorRegionDropDownList" runat="server"  DataSourceID="MajorRegionObjectDataSource" DataTextField="MajorRegionName" 
                                DataValueField="MajorRegionID" Width="405px"  ondatabound="MajorRegionDropDownList_DataBound"> </asp:DropDownList>
                            <asp:ObjectDataSource ID="MajorRegionObjectDataSource" runat="server"  SelectMethod="getAllMajorRegion" TypeName="CMS.BLL.CMSBLClass" 
                                OldValuesParameterFormatString="original_{0}"></asp:ObjectDataSource><br /><br />
                            <!-- Phone -->
                            ...
                            <asp:TextBox ID="StartDateTextBox" runat="server" Width="200px"   onkeydown = "return (event.keyCode!=13);"></asp:TextBox> 
                            <asp:CalendarExtender ID="StartDateTextBox_CalendarExtender" runat="server"  Enabled="True" TargetControlID="StartDateTextBox" 
                            ...
                            <asp:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender2" runat="server" TargetControlID="StartDateTextBox" 
                                WatermarkText="dd/mm/yyyy" WatermarkCssClass="waterMark"> </asp:TextBoxWatermarkExtender> <br /><br />
                            <!-- End Date -->
                            ...
                            <asp:CalendarExtender ID="EndDateTextBox_CalendarExtender" runat="server" Enabled="True" TargetControlID="EndDateTextBox" 
                                Format="dd/MMMM/yyyy"> </asp:CalendarExtender>
                            ...
                            <asp:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender1" runat="server" TargetControlID="EndDateTextBox" 
                                WatermarkText="dd/mm/yyyy" WatermarkCssClass="waterMark"></asp:TextBoxWatermarkExtender>
                            <span style="margin-left: -105px;"/><br /><br />
                            <!-- Opening Hours -->
                            <asp:Label ID="OpeningHoursLabel" CssClass="label" runat="server" Text="Opening Hours : " Font-Bold="True" Width="150px" ></asp:Label>
                            <asp:TextBox ID="OpeningHoursTextBox" runat="server" Width="400px" onkeydown = "return (event.keyCode!=13);"></asp:TextBox><br /><br />
                            <!-- Cost -->
                            ...
                            <asp:Rating ID="FreeRating" runat="server" MaxRating="1" StarCssClass="FreeRatingStar" WaitingStarCssClass="FreeSavedRatingStar"
                                    ...
                                    onchanged="FreeRating_Changed" AutoPostBack="True"></asp:Rating><br /><br />
                            ...
                            <div class="AddressMaster">                        
                                <asp:LinkButton ID="AutoLinkButton" runat="server" CssClass="tabButton"  Text="Auto Address" BackColor="LightGray" CausesValidation="false" 
                                    onclick="AutoLinkButton_Click"></asp:LinkButton>
                                <asp:LinkButton ID="ManualLinkButton" runat="server" CssClass="tabButton"  Text="Manual Address" BackColor="Gray" CausesValidation="false" 
                                    onclick="ManualLinkButton_Click"></asp:LinkButton>
                                <div class="Address">
                                    <asp:MultiView ID="AddressMultiView" runat="server">
                                        <!--========== Auto address input form ==========-->
                            ...
                            <div>
                                <asp:Label ID="Label6" runat="server" Text="Max Size: 50kb, Allowed Type: JPEG, PNG, GIF" CssClass="imgLabel"></asp:Label><br />
                            ...
                            <script type="text/javascript">
                            // Delete images from image thumb nail.
                            ...
                            <div class="detailButtons bottom">
                                <asp:MultiView ID="ButtonMultiView" runat="server">
                                    ...
                                    <asp:View ID="InsertButtonView" runat="server">
                                        ...
                                        <asp:ConfirmButtonExtender ID="InsertButton_ConfirmButtonExtender" OnClientCancel="CancelClick" runat="server" 
                                        ConfirmText="Do you want to submit the new event?" Enabled="True" TargetControlID="InsertButton" ConfirmOnFormSubmit="True">
                                        </asp:ConfirmButtonExtender>
